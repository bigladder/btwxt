...
TEST(GridAxis, bad_limits) {
  ...
  std::string ExpectedOut = "  INFO: The lower extrapolation limit (4) is within the set of "
  ...
  extrap_limits = {-2, 12};
  ExpectedOut = "  INFO: The upper extrapolation limit (-2) is within the set of grid values. "
