    ...
    class bdist_wheel(_bdist_wheel):
        ...
        def get_tag(self):
            ...
            if platform.system() != "Windows":
                ...
                #    ImportError: _btwxtairflow.so: undefined symbol: PyCMethod_New
            ...
            # "Binary wheel 'btwxt-3.1.0rc3-py3-none-linux_x86_64.whl'
...
setup(
    ...
    description="Btwxt python bindings.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/bigladder/btwxt",
    author="Big Ladder Software LLC",
    #author_email="btwxt@nrel.gov",
    #maintainer="Julien Marrec",
    #maintainer_email="contact@effibem.com",
    license="BSD3",
    project_urls={
        "Source Code": "https://github.com/jmarrec/btwxt",
    },
    platforms="any",
    ...
    keywords="btwxt py3 setuptools development",
    packages=find_packages(include=["btwxt"]),
    package_data={
        "btwxt": [
            "*.so",
            "*.pyd",
